...
\subsubsection{Calcular e Interpretar Medidas Estatísticas em Dados Clínicos}
...
\subsubsection{Compreender Intervalos de Confiança e P-Valores em IA}
...
\subsubsection{Diferenciar e Calcular Métricas de Desempenho Diagnóstico}
...
\subsubsection{Interpretar Curvas ROC, AUC e Matrizes de Confusão}
...
\subsubsection{Identificar e Evitar Vieses Estatísticos em IA Odontológica}
...
\subsubsection{Compreender Validação Interna vs. Externa e Generalização}
