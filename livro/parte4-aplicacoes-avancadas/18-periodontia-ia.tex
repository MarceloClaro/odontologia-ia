...
A periodontite, sexta doença mais prevalente no mundo, representa um desafio de saúde pública que combina alta prevalência, complexidade diagnóstica e impacto sistêmico. A inteligência artificial oferece ferramentas sem precedentes para enfrentar este desafio: da triagem populacional automatizada à predição de risco individualizada, passando pela quantificação objetiva de perda óssea. Neste capítulo, exploramos como CNNs, modelos tabulares e abordagens multimodais estão transformando a periodontia, permitindo diagnóstico mais preciso, prognóstico personalizado e integração com condições sistêmicas como diabetes e doenças cardiovasculares. A citação que abre este capítulo captura a magnitude do problema --- a periodontite como epidemia global --- e anuncia a promessa da IA como ferramenta de triagem populacional, tema que desenvolveremos ao longo das próximas seções.

\subsection{Objetivos de Aprendizagem}

Ao final deste capítulo, você será capaz de:

\subsubsection{Compreender a Classificação AAP/EFP 2018 e Seus Desafios}
Você analisará o sistema de estadiamento e graduação da periodontite, identificando por que a variabilidade interexaminador motiva o uso de IA.

\subsubsection{Implementar Classificação Automatizada de Perda Óssea}
Exploraremos CNNs para detectar e quantificar perda óssea alveolar em radiografias panorâmicas com alta sensibilidade.

\subsubsection{Construir Modelos Tabulares para Predição de Risco Periodontal}
Você aprenderá a integrar dados clínicos (PS, NIC, sangramento) em modelos de machine learning para prognóstico individualizado.

\subsubsection{Avaliar a IA como Ponte entre Periodontite e Condições Sistêmicas}
Discutiremos como a IA pode revelar correlações entre doença periodontal e diabetes, doenças cardiovasculares e outras comorbidades.
