...
\subsection{Compreender a Classificação AAP/EFP 2018 e Seus Desafios}
...
\subsection{Implementar Classificação Automatizada de Perda Óssea}
Exploraremos CNNs para detectar e quantificar perda óssea alveolar em radiografias panorâmicas com alta sensibilidade.

\subsection{Construir Modelos Tabulares para Predição de Risco Periodontal}
...
\subsection{Avaliar a IA como Ponte entre Periodontite e Condições Sistêmicas}
