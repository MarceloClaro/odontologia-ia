...
\subsection{Compreender o Paradigma dos Modelos Fundacionais}
...
\subsection{Aplicar o SAM à Segmentação de Dentes e Lesões}
...
\subsection{Usar Vision Transformers para Análise de Radiografias}
Você aprenderá como a arquitetura baseada em atenção supera CNNs em tarefas de classificação de patologias odontológicas.

\subsection{Identificar Alucinações em LLMs e Estratégias de Mitigação}
