...
A ortodontia foi pioneira na adoção de sistemas computacionais --- o primeiro sistema especialista ortodôntico data de 1987 --- e hoje lidera a integração da inteligência artificial no diagnóstico e planejamento de tratamento. Da cefalometria manual em papel acetato à detecção automatizada de landmarks com Transformers, o salto tecnológico é comparável à transição dos aparelhos fixos convencionais para os alinhadores transparentes. Este capítulo percorre as principais aplicações da IA em ortodontia: cefalometria automática com redes neurais, predição de extração, planejamento com alinhadores, segmentação 3D de modelos dentários e análise de crescimento facial. A citação que abre este capítulo remete à rica história computacional da especialidade e prepara o terreno para compreendermos como o deep learning está redefinindo cada etapa do fluxo ortodôntico.

\subsection{Objetivos de Aprendizagem}

Ao final deste capítulo, você será capaz de:

\subsubsection{Dominar Cefalometria Automática com Deep Learning}
Você aprenderá os paradigmas de regressão de coordenadas e mapas de calor para detecção automática de landmarks cefalométricos.

\subsubsection{Implementar Predição de Extração e Planejamento com Alinhadores}
Exploraremos como CNNs e séries temporais podem auxiliar na decisão de extração e no planejamento de tratamento ortodôntico.

\subsubsection{Segmentar Dentes em Modelos 3D para Ortodontia Digital}
Você aplicará técnicas de segmentação a escaneamentos intraorais e modelos digitais, habilitando a análise dente-a-dente.

\subsubsection{Analisar Crescimento Facial com Redes Neurais}
Discutiremos o estado da arte na predição de crescimento craniofacial, ferramenta essencial para o planejamento ortodôntico em crianças e adolescentes.
