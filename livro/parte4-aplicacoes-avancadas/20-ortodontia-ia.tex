...
\subsection{Dominar Cefalometria Automática com Deep Learning}
...
\subsection{Implementar Predição de Extração e Planejamento com Alinhadores}
...
\subsection{Segmentar Dentes em Modelos 3D para Ortodontia Digital}
Você aplicará técnicas de segmentação a escaneamentos intraorais e modelos digitais, habilitando a análise dente-a-dente.

\subsection{Analisar Crescimento Facial com Redes Neurais}
