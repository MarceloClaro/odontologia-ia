...
\subsection{Diferenciar Modelo 3D, Simulação e Gêmeo Digital}
...
\subsection{Integrar CBCT, Scanner Intraoral e Modelos de IA}
Exploraremos a fusão de múltiplas modalidades de imagem para criar réplicas virtuais completas do paciente.

\subsection{Aplicar Gêmeos Digitais ao Planejamento de Implantes e Cirurgia Ortognática}
Você aprenderá como gêmeos digitais permitem simular intervenções antes de realizá-las no paciente real.

\subsection{Implementar um Gêmeo Digital com o Módulo \texttt{odontoia.models.digital\_twin}}
