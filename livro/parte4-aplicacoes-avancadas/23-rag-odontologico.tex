...
\subsection{Compreender o Problema do Conhecimento Estático em LLMs}
...
\subsection{Dominar a Arquitetura RAG: Indexação, Recuperação e Geração}
Exploraremos cada componente do RAG --- embedding, banco vetorial, busca semântica e prompt aumentado --- com foco odontológico.

\subsection{Construir uma Base Vetorial com Artigos Odontológicos}
...
\subsection{Controlar Alucinações e Garantir Evidência nas Respostas}
