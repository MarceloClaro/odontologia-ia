...
\subsection{Compreender a LGPD Aplicada a Dados de Saúde Bucal}
Você aprenderá o que a lei classifica como dado sensível, as bases legais para tratamento e as penalidades por descumprimento no contexto odontológico.

\subsection{Implementar Consentimento Informado e Anonimização de Imagens}
Exploraremos templates de consentimento LGPD e técnicas de anonimização de radiografias e fotos intraorais para treinamento de modelos.

\subsection{Identificar Viés Algorítmico em Modelos Odontológicos}
Você analisará como etnia, gênero e classe social podem influenciar o desempenho de modelos e aprenderá estratégias para mitigar desigualdades.

\subsection{Conhecer a Regulação Nacional e Internacional de IA em Saúde}
Discutiremos o PL 2338/2023, o FDA e o CE Mark, preparando-o para os requisitos regulatórios de software odontológico com IA.
...
\subsubsection{Jurisprudência da ANPD}
...
\subsubsection{Anonimização vs. Pseudonimização}
...
\subsubsection{Elementos Obrigatórios do Termo de Consentimento}
...
\subsubsection{Posição da ANPD e do EDPB}
...
\subsubsection{K-Anonimato em Datasets Odontológicos}
...
\subsubsection{Transparência Radical}
...
\subsubsection{Destaque Regulatório}
...
\subsubsection{Predetermined Change Control Plan}
...
\subsubsection{Cenários de Responsabilidade}
...
\subsubsection{Pesquisa com Dados Retrospectivos}
