...
\subsection{Recapitular a Jornada de 28 Capítulos}
Você revisitará a arquitetura pedagógica completa do livro, conectando cada parte e compreendendo a progressão construída.

\subsection{Consolidar a Tríade: Evidência, Código e Ética}
Refletiremos sobre os três pilares que sustentam a prática responsável da IA odontológica: método científico, implementação técnica e responsabilidade profissional.

\subsection{Planejar Seus Próximos Passos com o Call to Action}
Você identificará ações concretas para aplicar o conhecimento adquirido: executar notebooks, contribuir com a comunidade OdontoIA e publicar seus resultados.

\subsection{Conectar-se à Comunidade OdontoIA e Continuar Aprendendo}
Ao final, você saberá como participar do ecossistema OdontoIA, acessar atualizações e contribuir para o futuro da odontologia digital brasileira.
