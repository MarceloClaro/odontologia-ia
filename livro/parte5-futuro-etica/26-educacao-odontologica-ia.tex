...
\subsection{Integrar IA no Currículo de Odontologia}
Você compreenderá as diretrizes curriculares nacionais e como a IA pode ser incorporada da graduação à educação continuada.

\subsection{Explorar Simuladores Inteligentes e Feedback Automatizado}
Aprenderá como simuladores hápticos e sistemas de visão computacional podem avaliar a qualidade de preparos cavitários e procedimentos clínicos.

\subsection{Utilizar o OdontoIA e Odontinho® como Ferramentas Educacionais}
Você conhecerá estas plataformas e descobrirá como utilizá-las no ensino de diagnóstico por imagem e planejamento de tratamento.

\subsection{Criar um Quiz Odontológico com IA Generativa}
Ao final, você desenvolverá uma atividade educacional prática usando IA para gerar perguntas, cenários clínicos e feedback personalizado.
