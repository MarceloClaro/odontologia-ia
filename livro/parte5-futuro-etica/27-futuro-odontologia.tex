...
\subsection{Compreender o Impacto da Bioimpressão 3D e IA Generativa}
Você explorará como a combinação de biomateriais, células vivas e algoritmos generativos pode revolucionar a odontologia regenerativa.

\subsection{Analisar o Papel de Wearables e IoT na Saúde Bucal}
Discutiremos como sensores intraorais e escovas inteligentes podem gerar dados contínuos para prevenção e monitoramento remoto.

\subsection{Projetar o Consultório Odontológico Inteligente de 2035}
Você integrará as tecnologias emergentes em uma visão coesa do fluxo clínico do futuro, da teleodontologia à Odontologia 5P.

\subsection{Refletir sobre os Novos Papéis do Dentista na Era da IA}
Ao final, você estará preparado para as competências exigidas do cirurgião-dentista em um cenário de transformação digital acelerada.
