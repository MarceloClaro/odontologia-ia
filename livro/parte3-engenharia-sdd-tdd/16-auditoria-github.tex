...
\subsection{Pesquisar Repositórios de IA Odontológica com Estratégias Avançadas}
Você dominará filtros de busca no GitHub para encontrar projetos de qualidade, com licença permissiva e código ativo.

\subsection{Avaliar Confiabilidade de Repositórios (Níveis G1 a G3)}
Aprenderá um protocolo sistemático de auditoria, distinguindo projetos de produção de experimentos abandonados.

\subsection{Aplicar TDD sobre Código de Terceiros}
Você aprenderá a escrever testes para garantir que códigos reaproveitados funcionem corretamente no seu contexto clínico.

\subsection{Transformar Repositórios em Notebooks Colab Reprodutíveis}
Ao final, você converterá qualquer repositório bem estruturado em um pipeline executável no Google Colab.
...
\subsubsection{OdontoAI — Classification}
...
\subsubsection{DENTEX — Dental Enumeration and Diagnosis}
...
\subsubsection{ToothSeg — Tooth Segmentation}
...
\subsubsection{MeshSegNet — 3D Dental Mesh Segmentation}
...
\subsubsection{MLUA — Machine Learning in Ultrasound Analysis}
...
\subsubsection{DentalMIM — Dental Model Innovation}
...
\subsubsection{Sinais estruturais e de autoria}
...
\subsubsection{Sinais de conteúdo e reprodutibilidade}
