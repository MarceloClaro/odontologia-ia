...
\subsection{Compreender a Importância da Interpretabilidade Clínica}
Você entenderá por que modelos opacos são inaceitáveis na saúde e como o shortcut learning pode enganar até métricas aparentemente excelentes.

\subsection{Aplicar Grad-CAM para Visualizar Atenção de CNNs}
Exploraremos mapas de ativação que revelam onde o modelo ``olha'' nas radiografias, validando se a atenção coincide com o raciocínio clínico.

\subsection{Usar SHAP e LIME para Explicar Predições}
Você aprenderá a interpretar modelos tabulares e de imagem, gerando relatórios de explicação comprensíveis por clínicos.

\subsection{Implementar um Pipeline XAI Completo}
Ao final, você integrará Grad-CAM, SHAP e relatórios de interpretabilidade em um sistema de apoio à decisão clínica.
