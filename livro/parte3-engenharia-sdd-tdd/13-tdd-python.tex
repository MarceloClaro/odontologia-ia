...
\subsection{Dominar o Ciclo TDD: Red, Green, Refactor}
Você aprenderá a escrever testes antes do código de produção, garantindo que cada funcionalidade seja validada desde o início.

\subsection{Criar Testes com pytest e unittest no Google Colab}
Exploraremos fixtures, mocks e asserts para testar desde funções isoladas até pipelines completos de IA odontológica.

\subsection{Testar Pré-processamento e Métricas Clínicas}
Você implementará testes para transformações de imagem, cálculo de Dice e sensibilidade, assegurando a correção matemática dos componentes.

\subsection{Configurar Cobertura de Testes e Integração Contínua}
Ao final, você integrará testes automatizados ao fluxo de desenvolvimento, garantindo reprodutibilidade e qualidade do código.
