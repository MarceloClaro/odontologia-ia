...
\subsection{Compreender a Epidemiologia do Câncer Oral no Brasil}
Você analisará os dados do INCA e entenderá por que o diagnóstico tardio é o principal fator de mortalidade.

\subsection{Aplicar Deep Learning à Histopatologia Digital}
Exploraremos como CNNs e Vision Transformers podem analisar lâminas histológicas para detectar carcinoma espinocelular oral.

\subsection{Desenvolver um Pipeline de Triagem para Atenção Primária}
Você projetará um sistema de baixo custo para detecção precoce de OPMDs em unidades básicas de saúde.

\subsection{Avaliar o Impacto Clínico da IA na Redução do Tempo Diagnóstico}
Aprenderá a mensurar o valor incremental da IA em termos de sensibilidade, especificidade e redução de encaminhamentos desnecessários.
...
\subsubsection{Causas do Diagnóstico Tardio}
...
\subsubsection{O Papel da IA na Triagem}
