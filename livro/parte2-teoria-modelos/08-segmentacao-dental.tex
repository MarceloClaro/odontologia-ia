...
\subsection{Diferenciar Tipos de Segmentação para Aplicações Clínicas}
Você compreenderá as diferenças entre segmentação semântica, de instância e panóptica, e saberá qual escolher para cada problema odontológico.

\subsection{Dominar a Arquitetura U-Net e suas Variantes}
Exploraremos a U-Net clássica, Attention U-Net, nnU-Net e 3D U-Net, entendendo como as skip connections preservam detalhes espaciais finos.

\subsection{Implementar Segmentação Dentária com Pipelines Completos}
Ao final, você implementará uma U-Net para segmentar dentes em radiografias panorâmicas, avaliando resultados com Dice e IoU.

\subsection{Avaliar Métricas de Segmentação e o Estado da Arte}
Aprenderá a interpretar Dice, IoU e distância de Hausdorff, comparando o desempenho dos modelos SOTA em datasets odontológicos.
